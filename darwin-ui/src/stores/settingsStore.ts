...
export const preferencesSchema = z.object({
  ...
  neuralBrightness: z.number().min(0.5).max(8).default(4.1),
  neuralThickness: z.number().min(0.5).max(5).default(2.8),
  neuralWarmth: z.number().min(0).max(10).default(7),
